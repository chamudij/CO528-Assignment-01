...
public class EmpController {
    ...
    @GetMapping("/getEmployeesByAddress/{address}")
    public ResponseEntity<ResponseDTO> getEmpByAddress(@PathVariable String address){
        try{
            List<EmpDTO> employeeList = empService.getEmpByAddress(address);
    ...
    @GetMapping("/searchEmployee/{empID}")
     public ResponseEntity<ResponseDTO> getEmpByAddress(@PathVariable int empID){
        try{
